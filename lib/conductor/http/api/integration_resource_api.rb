    ...
    module Api
      ...
      class IntegrationResourceApi
        ...
        def save_integration(body, name)
          @api_client.call_api('/integrations/provider/{name}', 'POST', path_params: { name: name }, body: body, return_http_data_only: true)
        end

        # Get an integration provider
        def get_integration(name)
          @api_client.call_api('/integrations/provider/{name}', 'GET', path_params: { name: name }, return_type: 'Integration', return_http_data_only: true)
        end

        # Get all integration providers
        def get_integrations
          @api_client.call_api('/integrations/provider', 'GET', return_type: 'Array<Integration>', return_http_data_only: true)
        end

        # Delete an integration provider
        def delete_integration(name)
          @api_client.call_api('/integrations/provider/{name}', 'DELETE', path_params: { name: name }, return_http_data_only: true)
        end
        ...
        def get_providers_and_integrations
          @api_client.call_api('/integrations/all', 'GET', return_type: 'Array<Integration>', return_http_data_only: true)
        end
      end
    end
  end
